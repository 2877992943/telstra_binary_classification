...
if __name__=='__main__':
	...
	for idi in uniqueId[:]:
		...
		#
		#count['vol_fea']=sum([int(v)*int(f) for v in fea_xi['volume'] for f in fea_xi['feature'] ])
		#count['sum_count']=sum([count['event_type_num'],count['resource_type_num'],count['feature_num'],\
					#count['volume_num']])
