...
if __name__=='__main__':
	...
	for idi,xi in dataDic.items():
		eventList=xi['event_type']
		for c in range(53):
			if str(c+1) in eventList:
				eventCount[c+1]+=1
			
		 
	print eventCount#{1: 4, 2: 37, 3: 19, 4: 1, 5: 26, 6: 28, 7: 24, 8: 29, 9: 14, 10: 145, 11: 7888, 12: 6, 13: 582, 14: 330, 15: 4395, 16: 0, 17: 3, 18: 73, 19: 14, 20: 1458, 21: 136, 22: 223, 23: 429, 24: 46, 25: 5, 26: 65, 27: 44, 28: 32, 29: 42, 30: 60, 31: 10, 32: 63, 33: 1, 34: 5927, 35: 6615, 36: 18, 37: 10, 38: 19, 39: 18, 40: 40, 41: 2, 42: 478, 43: 306, 44: 466, 45: 53, 46: 38, 47: 69, 48: 2, 49: 17, 50: 154, 51: 4, 52: 1, 53: 17}

	print sum(eventCount.values())
	...
	for idi,xi in dataDic.items()[:]:
		eventList=xi['event_type']
		if str(15) in eventList:
			dataDic_event15[idi]=xi
		if str(34) in eventList:
			dataDic_event34[idi]=xi
		if str(35) in eventList:
			dataDic_event35[idi]=xi

	#print len(dataDic_event11.values())+len(dataDic_eventRest.values())
		 
		 
	#print dataDic_seve1,dataDic_seve2,dataDic_seve345
	save2pickle([dataDic_event15,dataDic_event34,dataDic_event35],'dataDic_event11Rest')
...
severity_1 test0.65
severity_2 test0.38
severity_345  test0.7


resource_has2 test0.6
resource_has8 test 0.38
resource_has2or8 test0.5
"""	
