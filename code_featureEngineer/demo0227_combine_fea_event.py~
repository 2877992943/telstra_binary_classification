...
if __name__=='__main__':
	...
	#########
	dataDic_event15,dataDic_event34,dataDic_event35=load_pickle(dataPath+'dataDic_event11Rest')#{idi:[]...}
	...
	#merget dic: event34_35
	dicMerge=dataDic_event34.copy()
	dicMerge.update(dataDic_event35)
	print len(dicMerge)
	#
	dataDic_01_count={}
	for idi,xiDic in dicMerge.items()[:]:#just get idi
	...
	save2pickle([dataDic_01_count,targetDic],'xy_dummy_Count_event11')
