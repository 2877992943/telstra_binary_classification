...
if __name__=='__main__':
	...
	for idi,xi in dataDic.items():
		if xi['severity_type'][0] not in severityCount:
			severityCount[ xi['severity_type'][0] ]=1
		else:severityCount[ xi['severity_type'][0] ] +=1
	print severityCount#{'1': 8728, '3': 8, '2': 8737, '5': 65, '4': 1014}
