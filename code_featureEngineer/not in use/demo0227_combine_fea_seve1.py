...
if __name__=='__main__':
	...
	#########
	dataDic_seve1,dataDic_seve2,dataDic_seve345=load_pickle(dataPath+'dataDic_seve1_2_345') 
	...
	#
	dataDic_01_count={}
	#for idi,xiDic in dicMerge.items()[:]:
	for idi,xiDic in dataDic_seve2.items():
	...
	save2pickle([dataDic_01_count,targetDic],'xy_dummy_Count_seve1')
