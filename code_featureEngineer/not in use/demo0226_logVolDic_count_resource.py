...
if __name__=='__main__':
	...
	for idi,xi in dataDic.items():
		resourceList=xi['resource_type']
		for c in range(10):
			if str(c+1) in resourceList:
				resourceCount[c+1]+=1
			
		 
	print resourceCount#{1: 58, 2: 8918, 3: 145, 4: 330, 5: 14, 6: 582, 7: 498, 8: 10268, 9: 190, 10: 73}
	print sum(resourceCount.values())
	...
	dataDic_resource8={}	
	dataDic_resourceRest={}
	 
	for idi,xi in dataDic.items()[:]:
		resourceList=xi['resource_type']
		if str(2) in resourceList:
			dataDic_resource8[idi]=xi
		else:dataDic_resourceRest[idi]=xi

	print len(dataDic_resource8.values())+len(dataDic_resourceRest.values())
		 
		 
	#print dataDic_seve1,dataDic_seve2,dataDic_seve345
	save2pickle([dataDic_resource8,dataDic_resourceRest],'dataDic_resource8Rest')
